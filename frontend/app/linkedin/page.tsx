...
import {
  LINKEDIN_PREMIUM_SERVICES,
  LINKEDIN_SALES_NAV_SERVICES,
  LINKEDIN_FEATURE_COMPARISON,
  LINKEDIN_USE_CASES,
  LINKEDIN_FAQ_DATA
} from '@/utils/constants';

const premiumServices = LINKEDIN_PREMIUM_SERVICES;
const salesNavServices = LINKEDIN_SALES_NAV_SERVICES;
const featureComparison = LINKEDIN_FEATURE_COMPARISON;
const useCases = LINKEDIN_USE_CASES;
const faqData = LINKEDIN_FAQ_DATA;
