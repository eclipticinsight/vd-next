...
export const MARKETING_PRICING_SEO_PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      '8 article postings',
      '20 Bookmarking',
      '4 Facebook/Twitter/LinkedIn Posts',
  ...
  },
  {
    ...
    features: [
      ...
      '15 article postings',
      '30 Bookmarking',
      '8 Facebook/Twitter/LinkedIn Posts',
      '5 Quora answering',
      '2 PPT submissions',
      '2 Image/PDF submissions'
    ],
...
export const MARKETING_PRICING_SMO_PLANS = [
  {
    ...
    features: [
      '2 platforms (Facebook, Instagram, Twitter, LinkedIn, Pinterest)',
      '8-16 posts (static)',
      '0-2 short videos',
  ...
  },
  {
    ...
    features: [
      '5 platforms (Facebook, Instagram, Twitter, LinkedIn, Pinterest)',
      '20-25 posts (static/carousels)',
      '4-8 short videos/reels ',
      '5-10 stories',
  ...
  },
  {
    ...
    postsPerPlatformPerMonth: 16,
    engagement: 'Full-Service',
    icon: '👑',
    gradient: 'from-red-50 to-orange-50',
    borderColor: 'border-red-200',
    features: [
      'Unlimited platforms (as per your choice)',
      '30-35 posts (static/carousels)',
      '10-15 short videos/reels',
      '10-20 stories',
...
export const MARKETING_PRICING_CUSTOM_FORM_HEADER = {
  badge: "Customized Pricing",
  icon: "🛠️",
  title: "Design Your Custom Plan",
  description: "Build a custom plan tailored to your business goals. Select your service, enter your requirements, and our team will get back to you with a personalized proposal.",
  innerTitle: "Request a Custom Proposal",
  innerSubtitle: "Please fill out this form and our marketing team will contact you shortly."
};
