...
export const ROUTES: Record<string, string> = {
  ...
  "Financial Reporting and Analysis": "/accounting/financial-reporting",
  "Software Setup & Migration": "/accounting/software-setup",
...
export const FOOTER_QUICK_LINKS = [
  ...
  { label: "Marketing", href: "/webdesign" },
  { label: "I.T", href: "/mobile" },
];
